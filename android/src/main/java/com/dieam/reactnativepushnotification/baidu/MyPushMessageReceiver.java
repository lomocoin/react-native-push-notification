...
public class MyPushMessageReceiver extends PushMessageReceiver {
    public static final String TAG = "isme_push";
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            String action = context.getPackageName() + ".RNPushNotificationRegisteredToken";
    ...
    public static Bundle getRegisterBundle() {
        return mBundle;
    }
    ...
    public void onMessage(Context context, String message,
        ...
        /**
         * id : 1
         * action:'ChatMessage'|'GroupMessage'|'NewFriendRequest'|'FriendAcceptedRequest'
         * title:'昵称'|'群名''
         * content:'收到一条新消息'|'乔森森加你好友'|'thomas通过了你的好友请求'
         */

        Intent intent = new Intent();
        intent.setAction("test_joe");
        intent.putExtra("test", messageString);
        context.sendBroadcast(intent);
        ...
        try {
            ...
            bundle.putString("subText", ob.has("content") ? ob.getString("content") : "");
            bundle.putString("bigText", ob.has("content") ? ob.getString("content") : "");
            ...
            Log.e("isme_push", "透传消息不是一个有效的json：" + message);
        }
    }
